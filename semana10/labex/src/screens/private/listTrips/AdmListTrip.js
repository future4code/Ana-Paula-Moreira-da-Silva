...
import { ButtonDetails, ButtonDelete  } from '../../../functional/buttons'
...
function ListTrip() {
    ...
    const getTrips = useRequestData('https://us-central1-labenu-apis.cloudfunctions.net/labeX/Ana-epps/trips', [])


    //deletar viagem
    const deleteTrip = (id) => {
        axios
            .delete(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/Ana-epps/trips/${id}`,
            {
                headers: {
